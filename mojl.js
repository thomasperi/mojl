...
// 	"base": "./web/wp-content/themes/your-theme",
	...
	// to-do (in progress)
	// revert to using modules_dir as the directory ALL modules will be found in.
	// set to "." to just use the base directory.
	// 
	// Advantages:
	// * Lets php mojl continue to work without changes until using dir_mappings
	// * Lets the module name comments be the same generated by as 1.0.x
	//
	// Done so far:
	// * Refined testing to make spotting differences easier
	// * Reverted to 1.0.x tests
	// * Changed default dir_mappings/modules to [ "*" ]
	// * Added modules_dir back into the module paths when resolving to the filesystem
	//
	// Next to do:
	// * Maybe rename dir_mappings to build_mappings
	// * When old tests are passing again, add the new tests back
