...
// 	"base": "./web/wp-content/themes/your-theme",
	...
	//
	// * Change default dir_mappings/modules to [ "*" ]
	// * Add modules_dir back into the module paths when resolving to the filesystem
	// * Revert tests to those in last release, then add the new tests back
	// 
	// Advantages:
